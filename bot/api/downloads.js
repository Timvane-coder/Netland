...
import {obterCaminhoTemporario, formatarSegundos} from './util.js'
    ...
    return new Promise(async (resolve, reject)=>{
        try{
            ...
            await axios.get(url).then(({data}) =>{
                ...
                data.media_extended.forEach((midia)=>{
                    if(midia.type == 'video'){
        ...
        try{
            ...
            if(URL_VALIDA){
                ...
                await Youtube.default.searchOne(texto).then((pesquisaVideo)=>{
                    ...
                    resposta.erro = 'There was an error getting the video thumbnail.'
                    reject(resposta) 
                })
            }
            ...
            ytdl.getInfo(id_video, { 
                ...
                else resposta.erro = 'There was an error getting the video thumbnail.'
                reject(resposta)
            })
        } catch(err){
