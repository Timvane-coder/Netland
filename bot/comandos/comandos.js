export function comandosInfo(botInfo){
    ...
    const comandos = {
        ...
        info: {
            ...
            mydata: {
                ...
                msgs: {
                    ...
                    "Tye of user : *{p1}*\n"+
                    "Name : *{p2}*\n"+
                    "Total Command Used : *{p3}* comandos\n",
        ...
        utilidades: {
            ...
            brasileirao:{
                descricao: '',
                guia: `Ex: *${prefixo}brasileirao* -Displays the table and the current round of the Brasileirão Serie A.\n`+
                `Ex: *${prefixo}brasileirao* B - Displays the table and the current round of the Brasileirão Serie A.\n`,
                msgs: {
                    erro_serie: '[❗] The series entered is not supported, currently only A and B are supported.',
            ...
            pro : {
                descricao: '',
                guia: `Ex: *${prefixo}pro* Shortens the entered link.\n`,
                msgs: {
                    resposta : "✂️ Shortened Link ✂️\n\n"+
                    "*linking :* {p1}\n"
                }
            },
            upimg: {
                descricao: '',
                guia: `Ex: Send/reply an *image* with *${prefixo}upimg* - Uploads the image and returns the link.\n`,
                msgs: {
                    resposta : "IMAGE UPLOAD  🖼️\n\n"+
                    "*Link :* {p1}\n"
                }
            },
            filmes: {
                descricao: '',
                guia: `Ex: *${prefixo}filmes* - Displays the current trending movies.\n`,
                msgs: {
                    resposta : "🎬 TRENDING MOVIES 🎬\n\n"+
                    "{p1}\n"
                }
            },
            series: {
                descricao: '',
                guia: `Ex: *${prefixo}series* - Displays current series trends.\n`,
                msgs: {
                    resposta : "📺 SERIES TRENDS 📺\n\n"+
                    "{p1}\n"
                }
            },
            ia : {
                descricao: '',
                guia: `Ex: *${prefixo}ia* text- Receives an AI response based on the text.\n`,
                msgs: {
                    resposta: "🤖 AI Response:\n\n"+
                    "{p1}"
                }
            },
            criarimg: {
            ...
            lyrics: {
                descricao: '',
                guia: `Ex: *${prefixo}lyrics* name-musical - search lyrics for any music on the web.\n`,
                msgs: {
                    resposta : "🎼 MUSIC LYRICS 🎼\n\n"+
                    "Song : *{p1}*\n"+
                    "Artist : *{p2}*\n\n"+
                    "{p3}"
                }
        ...
        downloads: {
            mp3: {
                descricao: '',
                guia: `Ex: *${prefixo}mp3* music - Downloads a song from YouTube and sends it as audio.\n`,
                msgs: {
                    espera: "[WAIT] 🎧 Your song is being downloaded and processed.\n\n"+
                    "Title: *{p1}*\n"+
                    "Duration: *{p2}*",
                    limite: "[❗] The song must be less than *5 minutes*",
                    erro_live: "[❗] There was a download error, the bot does not accept live downloads."
                }
            },
            mp4: {
                descricao: '',
                guia: `Ex: *${prefixo}mp4* title - Downloads a video from YouTube with the title entered and sends it.\n`,
                msgs: {
                    espera: "[WAIT] 🎥 Your video is being downloaded and processed.\n\n"+
                    "Title: *{p1}*\n"+
                    "Duration: *{p2}*",
                    limite: "[❗] The video must be less than *5 minutes",
                    erro_live: "[❗] There was a download error, the bot does not accept live downloads."
                }
            },
            fb: {
                descricao: '',
                guia: `Ex: *${prefixo}fb* link - Downloads a video from Facebook using the link you entered and sends it.\n`,
                msgs: {
                    espera: "[WAIT] 🎬 Your media is being downloaded and processed.\n\n"+
                    "Title: *{p1}*\n"+
                    "Duration: *{p2}*",
                    limite: "[❗] The video must be less than *3 minutes",
                }
            },
            ig: {
                descricao: '',
                guia: `Ex: *${prefixo}ig* link - Downloads videos/photos from Instagram using the link you entered and sends it.\n`,
                msgs: {
                    espera: "[WAIT] 🎬 Your media is being downloaded and processed.",
                }
            },
            tw: {
                descricao: '',
                guia: `Ex: *${prefixo}tw* link - Downloads a video/image from Twitter using the link you entered and sends it.\n`,
                msgs: {
                    espera: "[WAIT] 🎬 Your media is being downloaded and processed.",
                }
            },
            tk: {
                descricao: '',
                guia: `Ex: *${prefixo}tk* link -Downloads a video from Tiktok using the link you entered and sends it.\n`,
                msgs: {
                    espera: "[WAIT] 🎬 Your media is being downloaded and processed.\n\n"+
                    "Perfil: *@{p1}*\n"+
                    "Descrição: *{p2}*\n",
            ...
            img: {
                descricao: '',
                guia: `Ex: *${prefixo}img* theme - Downloads an image with the theme you enter.\n`,
                msgs: {
                    erro_imagem: '[❗] Could not get any image, please try again.',
                }
            }
        },
        //COMANDOS GRUPO
        grupo: {
            status: {
                descricao: '',
                guia: `Ex: *${prefixo}status* - Displays the current group settings\n`,
                msgs: {
                    resposta_titulo: "[ 🤖 GROUP STATUS 🤖 ]\n\n",
                    resposta_variavel: {
                        bemvindo:{
                            on: "Welcome Feature : ✅\n",
                            off: "Welcome Feature : ❌\n"
                        ...
                        autosticker:{
                            on: "Auto-Sticker Feature : ✅\n",
                            off: "Auto-Sticker Feature : ❌\n"
                        },
                        antilink:{
                            on: "Feature Anti-Link : ✅\n",
                            off: "Anti-Link Feature : ❌\n"
                        },
                        antifake:{
                            on: "Anti-Fake : ✅\n"+
                            "- *Liberados* : {p1}\n",
                        ...
                        bloqueiocmds:{
                            on: "Command blocking : ✅\n"+
                            "- *{p1}*\n",
                            off: "Command blocking : ❌\n"
                        },
                        listanegra: "Blacklist: *{p1}*\n"
                    }
                }
            },
            fotogrupo: {
                descricao: '',
                guia: `Ex: Send/reply to an *image* with *${prefixo}fotogrupo* - Changes the group photo.\n\n`,
                msgs: {
                    sucesso: "🤖✅ GROUP photo was changed successfully.",
                }
            },
            regras: {
                descricao: '',
                guia: `Ex: *${prefixo}regras* - Displays the group description/rules\n`,
                msgs: {
                    sem_descrição: "[❗] The group does not have a description yet."
                }
            },
            addlista: {
                descricao: '',
                guia: `Ex: Reply someone with *${prefixo}addlista* - Adds the number of the person who was replied to the blacklist and bans them afterwards.\n\n`+
                `Ex: Mark someone with *${prefixo}addlista* - Adds the number of the person who was marked to the blacklist and bans them afterwards.\n\n`+
                `Ex: *${prefixo}addlista* +55219xxxx-xxxx - Adds the number entered to the group's blacklist and bans them afterwards.\n.`,
                msgs: {
                    sucesso: "✅ This user's number has been added to the blacklist and will be banned from the group if it is still here.",
                    bot_erro: "[❗] Calm down, you cannot add the BOT to the blacklist.",
                    admin_erro: "[❗] Calm down, you cannot add a ADMINISTRATOR the blacklist.",
                    ja_listado: "[❗] This user is already on the blacklist.",
                }
            },
            remlista: {
                descricao: '',
                guia: `Ex: *${prefixo}remlista* +55219xxxx-xxxx - Removes the entered number from the group's blacklist.\n`,
                msgs: {
                    sucesso: "✅ This user's number has been removed from the blacklist.",
                    nao_listado: "[❗] This user is not on the blacklist.",
                }
            },
            listanegra: {
                descricao: '',
                guia: `Ex: *${prefixo}listanegra* - Displays the group's blacklist.\n`,
                msgs: {
                    motivo: "Banned for being on the BLACKLIST",
                    lista_vazia: "🤖 There are no users on the blacklist of this group.",
                    resposta_titulo: "╔══✪〘❌ Blacklist 〙✪══\n╠\n",
                    resposta_itens: "╠➥ +{p1}\n"
                }
            },
            add: {
                descricao: '',
                guia: `Ex: *${prefixo}add* 5521xxxxxxxxx - Enter the number with the country code to add the person.\n\n`+
                `Ex: *${prefixo}add* 5521xxxxxxxxx, 5521xxxxxxxxx - Enter the numbers with the country code (adds more than one person to the group)..\n`,
                msgs: {
                    add_erro: "[❗] The number +{p1} cannot be added. You probably have privacy enabled, are already in the group, or the group is no longer accepting members.",
                    numero_invalido: "[❗] Houve um erro em adicionar o número {p1}, verifique se o número existe ou tente tirar o 9.",
                }
            },
            ban: {
                descricao: '',
                guia: `Ex: *${prefixo}ban* @membro - ParEnter the number with the country code to add the persona banir um membro marcando ele.\n\n`+
        ...
        //OUTROS
        outros : {
            inicializando: 'Initializing the BOT in version v{p1}...',
            dados_bot: "✓ Got data from the BOT",
            servidor_iniciado: '✓ Server started!',
            grupos_carregados: '✓ All groups were loaded and updated.',
            dono_cadastrado: `✅ Your number was registered as OWNER, now you can use the command ${prefixo}admin`,
            cabecalho_guia: `❔ USING THE COMMAND ❔\n\n`,
            usuario_novo: "[ 🤖 Welcome To {p1} 🤖]\n\n"+
            `👋 Hello {p2}, I saw that you are a new user to open the commands menu type *${prefixo}menu*`,
            entrada_grupo: "Greetings *{p1}* , if you have any questions just type"+`*${prefixo}menu*`,
            cmd_erro: "[❗] Oops, it looks like you used the command *{p1}* incorrectly or don't know how to use it. Want to learn how to use it?\n\n Type :\n  - Ex: *{p2} guia* to see the guide.",
            erro_comando_codigo: "[❗] There was an error in the command*{p1}*,report it to the administrator or try again later .",
            erro_api : "[❗] There was an error in the command *{p1}*.\n\n"+
            "Motivo: *{p2}*\n",
            resposta_ban : "🤖✅ ban_response, +{p1} will be banned.\n\n"+
            "Motivo : {p2}\n"+
            "Quem baniu : {p3}",
            fila_comando: "⏳ bot is serving too many people at once at the same time, please be patient!\n\n"+
            "There are currently *{p1}* commands in the queue.",
