        ...
        switch(comandoSemPrefixo){
            ...
            case `mydata`:
                try{
                    ...
                    let resposta = criarTexto(comandos_info.info.mydata.msgs.resposta_geral, tipoUsuario, nomeUsuario, dadosUsuario.comandos_total)
                    if(botInfo.limite_diario.status) resposta += criarTexto(comandos_info.info.mydata.msgs.resposta_limite_diario, dadosUsuario.comandos_dia, maxComandosDia, maxComandosDia)
                    if(mensagem_grupo){
